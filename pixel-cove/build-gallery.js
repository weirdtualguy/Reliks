...
const factory = JSON.parse(fs.readFileSync(fs.existsSync('factory-ledger-art.json') ? 'factory-ledger-art.json' : 'archive/v1-ledgers/factory-ledger-art.json', 'utf8'));

// Filter only the editions that belong to this specific art factory
const factoryEditions = editions.filter(e => e.factory_covid === factory.covenantId);
