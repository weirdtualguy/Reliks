const fs = require('fs');
const abi = JSON.parse(fs.readFileSync('edition-abi-v2.json', 'utf8'));
...
fs.writeFileSync('factory-args-v2.json', JSON.stringify(args));
console.log('✅ factory-args-v2.json written with real art');
