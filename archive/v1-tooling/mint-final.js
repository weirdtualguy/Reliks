...
async function main() {
  ...
  const FACT_TX = '588c629e9a0e530d71d2da7d506fbbb91ae907af18ca56ba8ae3c03b0e31b217';
  const FACT_SPK = 'aa2033f7b120f04ef503980fdaff633cd74421621e16b54dcb1bc1b09fcdb76018f387';
  ...
  const Rnext = B.concat([fp.prefix, encodeState(fAbi, fN,
    { art: ART, artist: USER, price: 100000000, royalty_bips: 500, cap: 64, counter: 1 }), fp.suffix]);
