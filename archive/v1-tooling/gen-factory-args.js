...
const art = new Array(2048).fill(0);

const args = [
  { kind: 'bytes', value: art },                    // program_art byte[2048]
  { kind: 'bytes', value: artist },                 // artist_id byte[32]
  { kind: 'int',   value: 100000000 },             // mint_price_sompi
  { kind: 'int',   value: 500 },                   // royalty_bips_val
...
fs.writeFileSync('factory-args.json', JSON.stringify(args));
console.log('✅ factory-args.json written with', args.length, 'args');
